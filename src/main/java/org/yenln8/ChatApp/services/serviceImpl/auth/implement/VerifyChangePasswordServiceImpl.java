...
@AllArgsConstructor
@Service
public class VerifyChangePasswordServiceImpl implements VerifyChangePasswordService {
    ...
    public BaseResponseDto call(VerifyOtpRequestDto form, HttpServletRequest request) {
        ...
        return BaseResponseDto.builder()
                ...
                .message(MessageBundle.getMessage("app.email.change.password.success"))
                .build();
    }
    ...
    private OTP validate(VerifyOtpRequestDto form, HttpServletRequest request) {
        ...
        Optional<OTP> optionalOTP = this.otpRepository.findByOtpCodeAndTypeAndDeletedAtIsNull(otpCode, OTP.TYPE.CHANGE_PASSWORD);
